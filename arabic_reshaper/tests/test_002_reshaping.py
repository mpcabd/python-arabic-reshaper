...
class TestDefaultReshaping(unittest.TestCase):
    def setUp(self):
        ...
        self.cases = (
            ('السلام عليكم', 'ﺍﻟﺴﻼﻡ ﻋﻠﻴﻜﻢ', 'السﻼم عليكم'),
            ('السَلَاْمٌ عَلَيْكُمْ', 'ﺍﻟﺴﻼﻡ ﻋﻠﻴﻜﻢ', 'السﻼم عليكم'),
            ...
            ('الأمم المتحدة، ويُحتفل',  'ﺍﻷﻣﻢ ﺍﻟﻤﺘﺤﺪﺓ، ﻭﻳﺤﺘﻔﻞ', 'اﻷمم المتحدة، ويحتفل'),
            ...
            ('الأمم المتحدة.', 'ﺍﻷﻣﻢ ﺍﻟﻤﺘﺤﺪﺓ.', 'اﻷمم المتحدة.'),
        )
